...
import type { BoardPostCreate } from '@/types/board'
...
export default function BoardPostWritePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: BoardPostCreate) => boardPostApi.createPost(boardCode, data),
    onSuccess: (post) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const postData: BoardPostCreate = {
      board_id: board!.id,
      tenant_id: tenantId,
